...
{
	private CompressedTexture2D collectedTexture     = GD.Load<CompressedTexture2D>("res://png/mapUI/check_collected.png");
	private CompressedTexture2D notCollectedTexture  = GD.Load<CompressedTexture2D>("res://png/mapUI/not_collected.png");
